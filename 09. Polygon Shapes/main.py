...
class TestGame(Widget):
    ...
    def draw_objects(self):
        ...
        #batholder
        col_shape = [{'shape_info': {'mass': 0, 'vertices': [(13, 16), (18, -38), (-19, -38), (-14, 16),
                                                             (0, 37)], 'offset': (0, 0)},
        ...
        #bat
        col_shape = [{'shape_info': {'mass': 300, 'vertices': [(-72, 9), (-77, 0), (-72, -9), (45, -5),
                                                               (45, 5)], 'offset': (0, 0)},
               'collision_type': 4, 'group': 1, 'elasticity': .11, 'friction': 1.0, 'shape_type': 'poly'},
                     {'shape_info': {'mass': 280, 'vertices': [(45, 0), (49, -11), (60, -15), (71, -11),
