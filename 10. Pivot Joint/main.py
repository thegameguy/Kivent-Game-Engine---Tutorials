...
class TestGame(Widget):
    ...
    def draw_objects(self):
        ...
        #bat
        col_shape = [{'shape_info': {'mass': 300, 'vertices': [(-72, 9), (-77, 0), (-72, -9), (45, -5), (45, 5)], 'offset': (0, 0)},
               'collision_type': 4, 'group': 1, 'elasticity': .8, 'friction': 1.0, 'shape_type': 'poly'},
                     {'shape_info': {'mass': 380, 'vertices': [(45, 0), (49, -11), (60, -15), (71, -11), (75, 0), (71, 11),
                                                               (60, 15), (49, 11)], 'offset': (0, 0)},
               'collision_type': 4, 'group': 1, 'elasticity': .8, 'friction': 1.0, 'shape_type': 'poly'},]
