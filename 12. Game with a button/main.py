...
class TestGame(Widget):
    ...
    def draw_objects(self):
        ...
        col_shape = [{'shape_info': {'mass': 300, 'vertices': [(-72, 9), (-77, 0), (-72, -9), (45, -5), (45, 5)],
                                     'offset': (0, 0)}, 'collision_type': 4, 'group': 1,
                                         'elasticity': .8, 'friction': 1.0, 'shape_type': 'poly'},
                     {'shape_info': {'mass': 380, 'vertices': [(45, 0), (49, -11), (60, -15), (71, -11),
                                                               (75, 0), (71, 11), (60, 15), (49, 11)],
    ...
    def level(self, click):
        ...
        # relocate button
        self.btn.pos = (1000, 400)

        #relocate button texture
        entity = entities[ent['start_btn']]
        entity_pos = entity.position
        entity_pos.pos = (1000, 400)


        objs = ['star1', 'star2', 'star3', 'star4', 'star5', 'star6', 'star7', 'star8', 'star9', 'star10', 'star11', 'star12', 'star13', 'star14', 'star15', 'star16', 'star17', 'star18', 'star19', 'star20', 'star21', 'star22', 'star23', 'star24', 'star25', 'star26', 'star27', 'star28', 'star29', 'star30', 'star31', 'star32', 'star33', 'star34', 'star35', 'star36', 'star37', 'star38', 'star39', 'star40', 'star41', 'star42', 'star43', 'star44', 'star45', 'star46', 'star47', 'star48', 'star49', 'star50',]
        ...
        pos = [(375, 400), (400, 75), (400, 115), (600, 450)]
