...
class TestGame(Widget):
    ...
    def level(self, click):
        self.gameworld.state = 'level'
        self.cur_state = 'level'
        entities = self.gameworld.entities
    ...
    def setup_states(self):
        self.gameworld.add_state(state_name='main',
            systems_added=[],
            systems_removed=[],
            systems_paused=['cymunk_physics', 'cymunk_touch',
             'particles', 'emitters', 'particle_renderer'],
        ...
        self.gameworld.add_state(state_name='level',
            systems_added=[],
            systems_removed=[],
            systems_paused=[],
            systems_unpaused=['renderer', 'position', 'rotate', 'color', 'scale',
        ...
        self.gameworld.add_state(state_name='paused',
            systems_added=[],
            systems_removed=[],
            systems_paused=['renderer', 'position', 'rotate', 'color', 'scale',
             'renderer2', 'camera1', 'cymunk_physics', 'cymunk_touch',
             'particles', 'emitters', 'particle_renderer'],
            systems_unpaused=[],
            screenmanager_screen='main')
    ...
    def pause_game(self, *args):
        self.gameworld.state = 'paused'

    def resume_game(self, *args):
        self.gameworld.state = self.cur_state
